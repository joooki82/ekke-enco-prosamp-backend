...
\fancypagestyle{report}{
	\fancyhf{}
	\fancyhead[L]{\footnotesize Tech Solutions Ltd., New York}
	\fancyhead[R]{\footnotesize \parbox{6cm}{\raggedleft Evaluate air quality in factory }}
	\renewcommand{\headrulewidth}{0.4pt}
	\renewcommand{\footrulewidth}{0.4pt}
	\fancyfoot[L]{\footnotesize Vizsgálati Jegyzőkönyv száma: TR-001}
