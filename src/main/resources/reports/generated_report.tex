...
% ==============================
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} 1.74 \end{minipage} &
...
\hline
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} 0.960 \end{minipage} &
...
\hline
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} < 0.420 \end{minipage} &
...
\hline
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} 0.810 \end{minipage} &
...
\end{longtable}
	...
	\begin{minipage}{5cm} \centering DDT \end{minipage} &
	\begin{minipage}{3cm} \centering \vspace{3pt} < 0.490 \end{minipage} &
...
\hline
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} 3.18 \end{minipage} &
...
\hline
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} 1.32 \end{minipage} &
	\begin{minipage}{2cm} \centering 4.39 \end{minipage} &
...
\hline
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} 0.910 \end{minipage} &
...
\hline
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} 0.880 \end{minipage} &
	\begin{minipage}{2cm} \centering 1.02 \end{minipage} &
...
\hline
	...
	\begin{minipage}{5cm} \centering DDT \end{minipage} &
	\begin{minipage}{3cm} \centering \vspace{3pt} 2.57 \end{minipage} &
...
\hline
	...
	\begin{minipage}{5cm} \centering DDT \end{minipage} &
	\begin{minipage}{3cm} \centering \vspace{3pt} 2.32 \end{minipage} &
...
\hline
	...
	\begin{minipage}{5cm} \centering E. coli \end{minipage} &
	\begin{minipage}{3cm} \centering \vspace{3pt} 1.43 \end{minipage} &
	\begin{minipage}{2cm} \centering 3.62 \end{minipage} &
	\begin{minipage}{2cm} \centering 1.45 \end{minipage} \\
\hline
	\begin{minipage}{2.5cm} \centering \vspace{3pt} \textbf{SMP-131} \vspace{3pt} \end{minipage} &
	\begin{minipage}{5cm} \centering Toluene \end{minipage} &
	\begin{minipage}{3cm} \centering \vspace{3pt} < 0.300 \end{minipage} &
	\begin{minipage}{2cm} \centering 3.62 \end{minipage} &
	\begin{minipage}{2cm} \centering < 196 \end{minipage} \\
\hline
	\begin{minipage}{2.5cm} \centering \vspace{3pt} \textbf{SMP-119} \vspace{3pt} \end{minipage} &
	\begin{minipage}{5cm} \centering Toluene \end{minipage} &
	\begin{minipage}{3cm} \centering \vspace{3pt} 0.750 \end{minipage} &
	\begin{minipage}{2cm} \centering 3.21 \end{minipage} &
	\begin{minipage}{2cm} \centering 0.760 \end{minipage} \\
\hline
	\begin{minipage}{2.5cm} \centering \vspace{3pt} \textbf{SMP-119} \vspace{3pt} \end{minipage} &
	\begin{minipage}{5cm} \centering Phthalates \end{minipage} &
	\begin{minipage}{3cm} \centering \vspace{3pt} 1.03 \end{minipage} &
	\begin{minipage}{2cm} \centering 3.21 \end{minipage} &
...
\hline
	...
	\begin{minipage}{3cm} \centering \vspace{3pt} 0.620 \end{minipage} &
...
\end{longtable}
				...
				*20 °C-ra és 101,3 kPa légköri nyomásra számított koncentráció
				...
				\parbox{\textwidth}{\raggedright \footnotesize
				Budapest, 2025-03-17				}
%				\noindent\textbf{Budapest, 2025-03-17} % Date aligned to the left
