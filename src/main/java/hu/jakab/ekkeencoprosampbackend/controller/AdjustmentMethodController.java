...
public class AdjustmentMethodController extends BaseController<AdjustmentMethodRequestDTO, AdjustmentMethodResponseDTO, Long> {
    ...
    @Override
    protected List<AdjustmentMethodResponseDTO> getAllEntities() {
        return service.getAll();
    }

    @Override
    protected Optional<AdjustmentMethodResponseDTO> getEntityById(Long id) {
        return service.getById(id);
    }

    @Override
    protected AdjustmentMethodResponseDTO createEntity(AdjustmentMethodRequestDTO dto) {
        return service.save(dto);
    }

    @Override
    protected Optional<AdjustmentMethodResponseDTO> updateEntity(Long id, AdjustmentMethodRequestDTO dto) {
